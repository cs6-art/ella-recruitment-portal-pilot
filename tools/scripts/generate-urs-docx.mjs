...
const outputPath = path.join(projectRoot, "docs", "USER-REQUIREMENTS-STUDY.docx");
...
const core = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/"><dc:title>McLink Group Recruitment Portal — User Requirements Study</dc:title><dc:creator>Recruitment Portal Project Team</dc:creator><cp:lastModifiedBy>Recruitment Portal Project Team</cp:lastModifiedBy></cp:coreProperties>`;
...
const temporaryDirectory = mkdtempSync(path.join(os.tmpdir(), "mclink-urs-docx-"));
try {
