  ...
  return (
    <main className="avatar-interview-page">
      <section className="avatar-interview-shell">
        ...
        <p className="avatar-interview-disclosure">Smile is an AI interviewer. Your response may be recorded, transcribed, and reviewed by the McLink Group recruitment team. This is not an automated hiring decision.</p>
      </section>
    </main>
  );
}
