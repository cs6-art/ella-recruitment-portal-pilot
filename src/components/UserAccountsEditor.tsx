  ...
  return (
    <main className="container page user-accounts-page">
      ...
      {canManageOrganizations && <section className="card organization-admin-card">
        ...
        <p className="field-hint">Every organization shares one database. Users, roles, applicants, and credits are fully isolated by organization ID -- creating an organization and adding its first user is all it takes for a new, empty workspace.</p>
      </section>}
